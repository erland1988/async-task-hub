                    ...
                    <template #default="{ row, column, $index }" v-if="!item.type">
                        <slot :name="item.prop" :rows="row" :index="$index">
                            <template v-if="item.prop == 'operator'">
                                <el-button v-if="(item.buttons || ['view', 'edit', 'delete']).includes('view')" type="warning" size="small" :icon="View" @click="viewFunc(row)">
                                  查看
                                </el-button>

                                <el-button v-if="(item.buttons || ['view', 'edit', 'delete']).includes('edit')" type="primary" size="small" :icon="Edit" @click="editFunc(row)">
                                  编辑
                                </el-button>

                                <el-button v-if="(item.buttons || ['view', 'edit', 'delete']).includes('delete')" type="danger" size="small" :icon="Delete" @click="handleDelete(row)">
                                  删除
                                </el-button>
                            </template>

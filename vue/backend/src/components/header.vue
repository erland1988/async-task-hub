<template>
    <div class="header">
        ...
        <div class="header-left">
            ...
            <div class="web-title">异步任务调度系统</div>
        ...
        <div class="header-right">
            <div class="header-user-con">
                ...
                <div class="btn-icon" @click="router.push('/ucenter')" v-if="notice">
...
const username: string | null = localStorage.getItem('admin:username');
const notice = ref(0);

...
import { LoginLog } from '@/types/login-log';
...
const getData = async () => {
    simpleApi.get('/api/admin/getLoginLog', { page: page.index, pageSize: page.size, keywords: query.keywords }, permiss.token, function(data){
